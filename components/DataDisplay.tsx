...
export function DataDisplay({ data, isLoading, dateRange }: DataDisplayProps) {
        ...
        <CardContent className="flex items-center justify-center p-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Please select a date range to view filtered data
            </p>
          </div>
        </CardContent>
      </Card>
    ...
    <div className="w-full max-w-7xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Data for {formatDate(dateRange.from)} to {formatDate(dateRange.to)}
          </CardDescription>
        </CardHeader>
      </Card>
